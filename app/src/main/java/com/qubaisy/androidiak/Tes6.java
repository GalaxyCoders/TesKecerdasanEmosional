...
public class Tes6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tes6);
       ...
       countDownTimer = new CountDownTimer(16 * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Tes6.this, Tes7.class);
        ...
        tangkapNilai = mIntent.getIntExtra("lempar5", 0);
        nilai = tangkapNilai;
