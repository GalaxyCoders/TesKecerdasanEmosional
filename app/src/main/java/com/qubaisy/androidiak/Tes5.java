...
public class Tes5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tes5);
       ...
       countDownTimer = new CountDownTimer(16 * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Tes5.this, Tes6.class);
        ...
        tangkapNilai = mIntent.getIntExtra("lempar4", 0);
        nilai = tangkapNilai;
