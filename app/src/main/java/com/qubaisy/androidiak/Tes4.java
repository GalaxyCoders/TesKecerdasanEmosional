...
public class Tes4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tes4);
       ...
       countDownTimer = new CountDownTimer(16 * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Tes4.this, Tes5.class);
        ...
        tangkapNilai = mIntent.getIntExtra("lempar3", 0);
        nilai = tangkapNilai;
