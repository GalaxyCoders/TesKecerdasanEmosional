...
public class Tes9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tes9);
       ...
       countDownTimer = new CountDownTimer(16 * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Tes9.this, Tes10.class);
        ...
        tangkapNilai = mIntent.getIntExtra("lempar8", 0);
        nilai = tangkapNilai;
