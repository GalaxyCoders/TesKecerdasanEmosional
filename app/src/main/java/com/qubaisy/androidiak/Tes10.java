...
public class Tes10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tes10);
       ...
       countDownTimer = new CountDownTimer(16 * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Tes10.this, TesBonus.class);
        ...
        tangkapNilai = mIntent.getIntExtra("lempar9", 0);
        nilai = tangkapNilai;
    }
    ...
    public void nextButton (View view){
        ...
        Intent intent = new Intent(Tes10.this,TesBonus.class);
        intent.putExtra("lempar10", tambah);
        startActivity(intent);
