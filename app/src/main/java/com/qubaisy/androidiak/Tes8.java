...
public class Tes8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tes8);
       ...
       countDownTimer = new CountDownTimer(16 * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Tes8.this, Tes9.class);
        ...
        tangkapNilai = mIntent.getIntExtra("lempar7", 0);
        nilai = tangkapNilai;
