...
public class Tes7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tes7);
       ...
       countDownTimer = new CountDownTimer(16 * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(Tes7.this, Tes8.class);
        ...
        tangkapNilai = mIntent.getIntExtra("lempar6", 0);
        nilai = tangkapNilai;
